...
class Blockchain(object): 
    ...
    def new_block(self, proof, previous_hash):
        ...
        :param proof: <int> The proof given by the Proof of work algirithm
    ...
    def new_transaction(self, sender, recipient, amount):
        """
        Createa new transaction to go into the next mined Block
    ...
    def valid_proof(last_proof, proof):
        ...
        :return: True if corrent, False if not.
        """
